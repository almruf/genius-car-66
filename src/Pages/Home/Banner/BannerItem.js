...
const BannerItem = ({slide}) => {
    ...
    return (
        <div id={`slide${id}`} className="carousel-item relative w-full my-4">
                   <div className="w-full h-screen banner-img-overlay ">
                   <img  src={image} className="w-full h-screen rounded-xl " alt=""/>
                   </div>
                  <div className="absolute flex justify transform -translate-y-1/2  left-10 top-40">
                     <h1 className='text-5xl font-semibold text-white ml-10'>
